...
popup_text1 <- dplyr::select(grizzdata_full, gbpu_name, status, adults, 
                               popiso, trend, threat_class, calcrank) %>% # Summary data for text popups
  rename("Population Name" = gbpu_name,
         "Overall Status" = status,
         "Population Size" = adults,
         "Isolation" = popiso,
         "Trend" = trend,
         "Threat Score" = threat_class,
         "M-Rank" = calcrank) 
