...
palette2 <- colorNumeric("PuBuGn", as.numeric(grizzdata_full$pop_density),
                        na.color = "#808080")
...
grizzmap %>%
  addPolygons(data = grizzdata_full, #group = "Population Estimate",
              ...
              fillOpacity = 0.6,
              fillColor = ~palette2(as.numeric(grizzdata_full$pop_density)),
              label = plotlabs,
              labelOptions = labelOptions(direction = "auto", textsize = "12px"),
              popup = popups,
  ...
  addLegend("bottomright", pal = palette2, 
            values = as.numeric(grizzdata_full$pop_density),
            title = "Population\nDensity", na.label = "Extirpated",
            opacity = 1) #%>%
  #addLayersControl(overlayGroups = c("Terrain", "Topography"))
```
...
grizzmap %>% 
  ...
  addPolygons(data = grizzdata_full,
              stroke = T, weight = 1, color = "black",
              fillOpacity = 0.4,
              fillColor = ~tpalette(grizzdata_full$residentialcalc),
              group = "Residential",
              label = plotlabs,
              labelOptions = labelOptions(direction = "auto", textsize = "12px"),
              highlight = highlightOptions(
  ...
  addPolygons(data = grizzdata_full,
              stroke = T, weight = 1, color = "black",
              fillOpacity = 0.4,
              fillColor = ~tpalette(grizzdata_full$agriculturecalc),
              group = "Agriculture",
              label = plotlabs,
              labelOptions = labelOptions(direction = "auto", textsize = "12px"),
              highlight = highlightOptions(
  ...
  addPolygons(data = grizzdata_full,
              stroke = T, weight = 1, color = "black",
              fillOpacity = 0.4,
              fillColor = ~tpalette(grizzdata_full$biousecalc),
              group = "Biouse",
              label = plotlabs,
              labelOptions = labelOptions(direction = "auto", textsize = "12px"),
              highlight = highlightOptions(
  ...
  addPolygons(data = grizzdata_full,
              stroke = T, weight = 1, color = "black",
              fillOpacity = 0.4,
              fillColor = ~tpalette(grizzdata_full$climatechangecalc),
