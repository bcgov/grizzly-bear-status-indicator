...
* Conservation ranks were calculated based on NatureServe’s ['Element Rank Calculater'](https://www.natureserve.org/conservation-tools/conservation-rank-calculator) in conjunction with Provincial bear biologists. This ensured rankings were consistent with international standards (B.C. Conservation Data Centre, NatureServe, IUCN). 
...
*^4^ [Province of British Columbia. 2019. Ranking the Conservation of Grizzly Bear Population Units]()
...
Published and Available On-Line at Environmental Reporting BC (June `r format(Sys.Date(), "%Y")`):  
