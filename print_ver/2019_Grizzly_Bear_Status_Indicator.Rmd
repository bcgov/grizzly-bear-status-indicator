...
```{r radar_key, echo = FALSE, message=FALSE, fig.align='right', fig.cap = "Contribution of three criteria (Trend, Threat, Population/Isolation) to the overall ranking per GBPU. Each arm represents the maximum value per contribution to the overall rank. For example: Population/Isolation can range from 0-4, Threat (0-2) and Trend (1). The more coloured area represent the higher the factor influences the overall ranking. Colours correspond to conservation ranking." , out.width='0.30\\linewidth'}
