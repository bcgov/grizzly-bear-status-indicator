...
```{r threat_detail, echo = FALSE, message=FALSE, fig.align='center', fig.cap = "Influence of three contributing factors to conservation concern ranking per GBPU. Contributing factors include population trend, population size and isolation and overall threat.", out.width='0.99\\linewidth'}
